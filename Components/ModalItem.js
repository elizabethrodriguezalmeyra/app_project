    ...
    <Modal
        ...
        <View style={styles.modalCentered}>
         ...
         <View style={styles.tituloModal}>
          <Text style={styles.textoTitulo}>CursArte</Text><Text style={styles.textoTitulo} onPress={onCancel.bind(this)}>X</Text>
        </View>
        <View style={styles.cuerpoModal}>
          <View>
            <Text>Desea Borrar {item.value} de {item.year}ª año?</Text>
          </View>
